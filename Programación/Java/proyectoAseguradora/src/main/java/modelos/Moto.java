...
public class Moto extends Vehiculo {
    ...
    public Moto(int id, String marca, String modelo, String matricula, LocalDate fechaMatriculacion, String color, Personas duenyoActual, int cilindradaCC, boolean tieneSidecar) {
