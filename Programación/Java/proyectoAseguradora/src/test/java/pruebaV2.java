...
public class pruebaV2 {
    public static void main(String[] args) {
        ...
        Personas persona = new Personas(1, "Juan", "Pérez", "Gómez", "12345678Z", LocalDate.of(2007, 5, 15), direccion, Personas.Sexo.MASCULINO, "España", "assdas@gmail.com","698538847");
        Conductor conductor = new Conductor(2, "Luis", "Martínez", "López", "87654321B", LocalDate.of(1985, 8, 20), direccion, Personas.Sexo.MASCULINO, "España", "assdas@gmail.com","698538847", LocalDate.of(2005, 6, 10), 12, 5);
        ...
        Vehiculo vehiculo = new Vehiculo(1,"Ford","Focus","0366DFX",LocalDate.of(2004,12,21),"Azul",null);
